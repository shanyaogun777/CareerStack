...
3. 保存后，**岗位库** 中的 **AI 智能解析 JD**、**匹配度诊断**、**简历润色**、**面试题生成/解析** 等功能会通过你配置的地址与密钥直连模型服务商；请求由你的浏览器发起，不经过 CareerStack 后端中转。
...
| **简历生成中心** | 从素材库拖拽/编排内容，生成与导出简历（含 PDF）。 |
...
如遇任何问题或有功能建议，请点击 [此处填写问题反馈](https://xcnlrv02xcir.feishu.cn/share/base/form/shrcnWGXuESqLkSs72rhyiSKCEk)。
`.trim()
